...
$(function() {
    ...
    $('#serviceTotalTime').text(dataInProvince.totalServiceTime / 60);*/
...
/*function dancingNumCount() {
    ...
    var dancingNum3 = new CountUp("serviceTotalTime", 0, dataInProvince.totalServiceTime/60, 0, 2, options);
    dancingNum1.reset();
    dancingNum1.start(function () {
    ...
    dancingNum3.reset();
    dancingNum3.start(function () {
        dancingNum3.update(dataInProvince.totalServiceTime/60);
    });
}*/
/*---------数字跳动效果结束----------*/
